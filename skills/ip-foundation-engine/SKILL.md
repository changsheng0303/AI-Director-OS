...
5. Expand only the approved main cast. Separate identity, behavior, voice, visual identity, and relationship function. Keep current state outside this package.
